...
@Component({
  selector: 'app-template-nine',
  templateUrl: './template-nine.component.html',
  styleUrls: ['./template-nine.component.scss']
})
export class TemplateNineComponent implements OnInit, OnChanges {
