...
@Component({
  selector: 'app-template-muse',
  templateUrl: './template-muse.component.html',
  styleUrls: ['./template-muse.component.scss']
})
export class TemplateMuseComponent implements OnInit {
