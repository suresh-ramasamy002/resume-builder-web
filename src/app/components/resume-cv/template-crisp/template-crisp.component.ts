...
@Component({
  selector: 'app-template-crisp',
  templateUrl: './template-crisp.component.html',
  styleUrls: ['./template-crisp.component.scss']
})
export class TemplateCrispComponent implements OnInit {
