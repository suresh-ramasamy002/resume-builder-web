...
@Component({
  selector: 'app-template-iconic',
  templateUrl: './template-iconic.component.html',
  styleUrls: ['./template-iconic.component.scss']
})
export class TemplateIconicComponent implements OnInit {
