...
@Component({
  selector: 'app-template-vibes',
  templateUrl: './template-vibes.component.html',
  styleUrls: ['./template-vibes.component.scss']
})
export class TemplateVibesComponent implements OnInit {
