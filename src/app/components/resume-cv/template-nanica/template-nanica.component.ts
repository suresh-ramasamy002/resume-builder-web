...
@Component({
  selector: 'app-template-nanica',
  templateUrl: './template-nanica.component.html',
  styleUrls: ['./template-nanica.component.scss']
})
export class TemplateNanicaComponent implements OnInit {
  ...
  setFontSize(starType) {
    let size = '1em';
    switch (starType) {
      case 'round': size = '1.6em'; break;
      case 'square': size = '1.8em'; break;
      case 'star':  size = '1.2em'; break;
      case 'diamond': size = '1.2em'; break;
    }
    return size;
  }
}
