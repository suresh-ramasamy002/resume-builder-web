...
@Component({
  selector: 'app-template-influx',
  templateUrl: './template-influx.component.html',
  styleUrls: ['./template-influx.component.scss']
})
export class TemplateInfluxComponent implements OnInit {
