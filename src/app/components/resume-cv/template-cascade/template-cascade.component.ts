...
@Component({
  selector: 'app-template-cascade',
  templateUrl: './template-cascade.component.html',
  styleUrls: ['./template-cascade.component.scss']
})
export class TemplateCascadeComponent implements OnInit {
